...
function UpdateProfileForm(props){
    ...
    const handleSubmit =(event) =>{
        ...
        //checking for null values in the form and removing
    ...
    return (
        ...
        onSubmit={handleSubmit}>
                ...
                <Form.Control onChange={(e)=>setAvatar(e.target.files[0])}
                ...
                <div className="text-content text-danger">{erorr && <p>{erorr}</p>}</div>
